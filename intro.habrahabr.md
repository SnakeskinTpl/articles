...
Основной мотивацией для написания Snakeskin было желание иметь язык шаблонов с огромными возможностями для повторного использвания кода, и который можно было бы использовать на сервере и на клиенте одинаково, без необходимости изменения кода. 
