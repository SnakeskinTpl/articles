...
Всем привет! В этом посте я хочу рассказать о своей разработке: ЯП для описания текстовых шаблонов - Snakeskin.
...
У нас в отделе в ту пору использовался TemplateToolkit2, популярный у Perl разработчиков шаблонизатор, а на клиенте
простейший MicroTemplate от Ресига. Также следует отметить, что в то время активно форсились XSLT-подобные решения, но 
по ряду причин мы отказались от них. Время от времени мы экспериментировали с другими движками: Handlebars, Dust, Closure Templates, 
...
но с блэкджеком и шлюхами, который был бы написан на JS и был более открытый к модификациям. Также я захотел добавить
...
С результатом я немного поигрался, поделился с коллегами и получил некоторый фидбэк. 
...
Теперь, когда я описал свои мотивы и основные use-case, я расскажу про сам язык, но цель данного поста не дублирование 
...
ADVANCED. Код хорошо документирован в соответствии со стандартом JSDoc от Google.
